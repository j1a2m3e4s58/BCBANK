...
import { Smartphone, CheckCircle2, ArrowRight, RefreshCw } from "lucide-react";

const networks = [
  { id: "mtn", name: "MTN MoMo", color: "from-yellow-500/20 to-yellow-500/5", border: "border-yellow-500/30", text: "text-yellow-400", logo: "🟡" },
  { id: "vodafone", name: "Vodafone Cash", color: "from-red-500/20 to-red-500/5", border: "border-red-500/30", text: "text-red-400", logo: "🔴" },
  { id: "airteltigo", name: "AirtelTigo Money", color: "from-blue-500/20 to-blue-500/5", border: "border-blue-500/30", text: "text-blue-400", logo: "🔵" },
];
...
const recentMoMo = [
  ...
  { id: 2, name: "Ama Owusu", number: "0201234567", network: "Vodafone Cash", time: "Yesterday" },
        ...
        {success ? (
          <motion.div key="success" initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ opacity: 0 }}>
            <GlassCard glow className="text-center py-10 space-y-3">
              ...
              <div>
                <p className="text-xl font-heading font-bold text-foreground">GH₵ {form.amount} Sent!</p>
              ...
              <Button onClick={reset} className="bg-primary text-primary-foreground mt-2">Send Again</Button>
            </GlassCard>
          </motion.div>
        ) : (
              ...
              <div className="grid grid-cols-3 gap-2">
                {networks.map(n => (
                  <button key={n.id} onClick={() => setNetwork(n)}
                    ...
                    <div className="text-xl mb-1">{n.logo}</div>
                ...
                <GlassCard className="space-y-3">
                  <div className="space-y-1.5">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Input placeholder="24 123 4567" value={form.phone} onChange={e => setForm(f => ({ ...f, phone: e.target.value }))}
